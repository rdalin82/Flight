...
ActiveRecord::Schema.define(version: 20160519022458) do
  ...
  add_index "trips", ["end_airport_id"], name: "index_trips_on_end_airport_id"
  add_index "trips", ["start_airport_id"], name: "index_trips_on_start_airport_id"
